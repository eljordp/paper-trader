...
import { AI_TRADER_SLUG } from "@/lib/aiTrader";
...
export default async function AiTraderPage() {
  ...
  if (!profile) {
    return (
      <div className="max-w-2xl mx-auto px-6 py-20 text-center space-y-4">
        <h1 className="font-serif text-4xl">AI Trader</h1>
  ...
  const displayName = p.display_name ?? "AI Trader";
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-start gap-5">
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm text-[var(--color-text-dim)] max-w-xl">
                Researches the market every morning, runs its own strategies,
                takes its own trades. No human input. Watch it work.
              </div>
              <div className="text-xs text-[var(--color-text-faint)]">
                Trading since {memberSince}
              </div>
            </div>
          </div>
        </div>
